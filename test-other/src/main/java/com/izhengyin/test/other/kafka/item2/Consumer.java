package com.izhengyin.test.other.kafka.item2;
...
public class Consumer extends ShutdownableThread {
    ...
    public void doWork() {
        ...
        for(ConsumerRecord<Integer,String> consumerRecord : consumerRecords){
            System.out.println(groupId +" Thread : "+ Thread.currentThread().getName()+ " Received message: (" + consumerRecord.key() + " => " +consumerRecord.value()+ ") at offset " + consumerRecord.offset()+" partition["+consumerRecord.partition()+"]");
        }
    }
