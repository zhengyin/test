package com.izhengyin.test.spring.aop.autoProxy.defaultAdvisor;
...
public class Test {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("spring/aop/autoProxy/defaultAdvisor/aop.xml");
