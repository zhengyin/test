...
public class SparkSqlOnHiveTest {
    ...
    public static void main(String[] args) throws AnalysisException {
        ...
        SparkSession sparkSession = SparkSession.builder()
                ...
                .config("spark.sql.warehouse.dir","hdfs://kongfz/spark/warehouse")
        ...
        Dataset<Row> df = sparkSession.read().parquet("hdfs://kongfz/data/analysis/events/2018/8/10/dataFile_Events_analysis-job-02-vm_10.parquet");
        df.printSchema();
